<DIV class="header" style>
  <DIV class="header_logo">
    <A href="${basePath}/index">
      <IMG alt="贴图库Logo" src="${basePath}/static/image/logo11.png"></A>
  </DIV>
  <DIV class="header_user header_user_unsignin">
    <SPAN class="header_user_up">
      <a href="${basePath}/album" class="header_user_up_pc-3" style="display:block;">个人相册</a>
     <A href="${basePath}/upload/local" class="header_user_up_pc"  id="localImage">上传电脑图片</A>
     <A href="${basePath}/upload/network" id="networkImage">上传网络图片</A>
    </SPAN>
 </DIV>
...
<DIV class="header_nav" style="padding-right: 50px;">
	<span id="sub_hov" style="position:relative;">
		<a href="javascript:;">${session_user_key.nickname}
		<b class="caret"></b></a>
		<SPAN>&nbsp;&nbsp;</SPAN>
		<div id="sub_nav" style="right:0;top:30px;">
			<ul>
				<li><A href="${basePath}/album">个人相册</A></li>
...
<DIV class="header_nav">
	<a href="#" style="border:none;">
			<img src="${basePath}/static/image/userphoto.png" title="登陆用户" class="vipicon" /></a>
	</DIV>
</DIV>
